    ...
    <div>
      ...
      <div className="flex flex-col justify-center items-center h-screen font-poppins">
        ...
        <h3 className="text-xl mt-4 text-slate-800 w-[90%] text-center lg:w-[70%]">
          An demo that illustrates how Livepeer can be used as a video processing and caching layer on top of content
          available on IPFS or the Arweave gateway for optimized video playback.
        </h3>
              ...
              <div key={index} className="relative">
                ...
                <div className="absolute top-0 right-0 m-1 font-semibold border border-white bg-white rounded-full">
                  <img
                    ...
                    src={video.storageType === 'ipfs' ? 'logos/ipfs.png' : 'logos/arweave.png'}
                  />
                </div>
              </div>
            ))}
